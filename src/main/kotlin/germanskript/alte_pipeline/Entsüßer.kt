...
class Entsüßer(startDatei: File): PipelineKomponente(startDatei) {
  ...
  private fun entsüßeFürJedeSchleife(fürJedeSchleife: AST.Satz.FürJedeSchleife) {
    ...
    holeIteratorAufruf.aufrufTyp = FunktionsAufrufTyp.METHODEN_NACHRICHTEN_OBJEKT_AUFRUF
    val holeIterator = AST.Satz.Ausdruck.NachrichtenBereich(iterierbar, AST.Satz.Bereich(mutableListOf(holeIteratorAufruf)))
